...
MODEL_CLASSES = {
    'gpt2': (GPT2LMHeadModel, YTEncoder),  # GPT2Tokenizer
...
def sample_sequence(model, length, context, num_samples=1, temperature=1, top_k=0, top_p=0.0,
                    is_xlnet=False, device='cpu', max_input=1023, filter_single=None, filter_double=None):
    if filter_double is None:
        filter_double = []
    if filter_single is None:
        filter_single = []
