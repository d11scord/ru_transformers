...
from fastai.basics import flatten_model, requires_grad

from run_generation import sample_sequence

from transformers import (WEIGHTS_NAME, AdamW, get_constant_schedule_with_warmup,
...
MODEL_CLASSES = {
    'gpt2': (GPT2Config, GPT2LMHeadModel, YTEncoder),
